#!/usr/bin/env python3
"""
Medical Waste Setup Module
Consolidated setup script for medical waste management in ERPNext
"""

import frappe

def setup_medical_waste():
    """Setup medical waste management system"""
    ...
    def create_waste_item_template():
        """Create custom fields for waste items"""
    ...
    # Main execution
    try:
        print("🏗️  Setting up Medical Waste Management System...")
        ...
        frappe.db.commit()
        print("\n✅ Medical waste management setup completed successfully!")
